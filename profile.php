...
<body>
	...
	<div class="navbar navbar-default navbar-fixed-top"  id="topnav">
		<div class="container-fluid">
			<div class="navbar-header">
				<a href="index.php" class="navbar-brand">TrendBee</a>
			</div>
			...
			<ul class="nav navbar-nav navbar-right">
				...
				<li class="chatbot"><a href="chatnow.html">Chat Now</a></li>
	...
	<!-- Slider Begins -->
	 ...
	 <div class="one-time">
	    <div><img src="assets/images/car0.jpg"></div>
	    <div><img src="assets/images/car.jpg"></div>
